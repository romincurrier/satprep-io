...
export default async function handler(req,res){
 ...
 }catch(e){console.error('create-checkout-session',e);const status=Number(e.status);return json(res,status===503?503:500,{error:status===503?e.message:'Unable to start checkout right now.'})}
}
