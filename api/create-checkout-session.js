...
import {assertBillingRequestOrigin,assertCheckoutSurfaceEnabled,billingContext,safeSiteOrigin,stripeRequest,stripeSecret} from '../server/stripe-server.js';
...
export default async function handler(req,res){
 ...
 try{
  assertBillingRequestOrigin(req);assertCheckoutSurfaceEnabled(req);stripeSecret(); // Public launch and live-key locks are both server enforced.
