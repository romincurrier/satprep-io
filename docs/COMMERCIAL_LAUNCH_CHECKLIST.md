...
**AI advisory review progress (2026-09-01):** the 434-item expansion bank remains **434/434 AI-reviewed, with 0 remaining**. After the latest construct-quality pass, the formula-backed advisory ledger reports **434 PASS / 0 REVISE / 0 REJECT / 0 NEEDS HUMAN REVIEW**, **85 difficulty changes**, human-review priority of **0 Critical / 103 High / 174 Medium / 157 Normal**, and a reviewed difficulty mix of **184 Easy / 153 Medium / 97 Hard**. QA found a systematic difficulty-progression defect in `words-in-context`: all six author-Medium items and all four author-Hard items had previously calibrated to Easy because the passages frequently supplied near-direct paraphrases of the keyed meaning. The four appropriate Easy anchors were retained. Ten drafts were substantively rebuilt around high-utility academic words and phrases in richer history/social-science/science contexts with plausible competing senses, including `qualify`, `reserve`, `authority`, `commensurate`, `account for`, `address`, `provisional`, `yielded`, `sustain`, and `circumscribes`. Fresh advisory review now classifies all six Medium drafts as Medium and all four Hard drafts as Hard, with the Hard items High-priority for independent human review. The revisions preserve the official Words in Context question behavior while making difficulty arise from contextual precision, polysemy, abstraction, and competing senses rather than obscure vocabulary alone. This remains AI QA only; no item is represented as independently approved, and difficulty still requires empirical calibration. Prior construct-quality and exam-eligibility corrections remain in force.

**Current staging integrity (2026-09-01):** exact post-write checks show **0/434 `production_approved=TRUE`**, **0 `#REF!` values in `Questions`, `AI Review`, `Coverage`, `Instructions`, `Review Guide`, or `AI Review Summary`**, exact current SHA-256 binding between each revised Words in Context staging row and its advisory-review row, and independent canonical-hash recomputation for all ten revised items. The 14-item Words in Context skill set has **0 exact or near-duplicate pairs at the importer threshold of 0.96** (maximum observed token Jaccard similarity approximately 0.209). The formula-backed summary remains **434 staged / 434 reviewed / 0 remaining**, and all formula-owned `AI Review` metadata continued to spill normally because writes were confined to the runbook-authorized columns. Every edited item remains `qa_status='draft_unreviewed'`; no reviewed staging item has been independently approved, imported, activated, or externally published. The existing within-bank duplicate/near-duplicate guard remains in force; cross-bank screening against the separately inaccessible 94-item bank is still required before launch.
