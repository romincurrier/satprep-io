...
console.log(`Practice content validation passed: ${PRACTICE_BANK.length} separate practice-only items (${practiceBySection.RW||0} RW, ${practiceBySection.MATH||0} Math) covering all ${Object.keys(SKILL_INDEX).length} official skill points.`);
